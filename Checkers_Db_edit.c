...
#define Choose( n, k )          ( Bicoef[ (int) n ][ (int) k ] )
...
long DBLookup()
{
        ...
        /* Find out its index */
        index = (int)dbLocbvToSubIdx( &dbentry );
 ...
 *      checker configuration is 8.printf("test %d\n",(*dbentry)->value);
 *
